#!/usr/bin/env python3
"""Direct upload to HuggingFace without input prompts."""
...
def upload_to_huggingface():
    ...
    username = "omgbobbyg"  # Your HuggingFace username
    ...
    try:
        ...
        try:
            ...
            print(f"Repository might already exist or created: {e}")
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("Uploading YOLOv8 VHR-10 model to HuggingFace Hub...")
    print()
    
    repo_url = upload_to_huggingface()
    
    if repo_url:
        print(f"\n✅ SUCCESS! Model repository created at:")
        print(f"   {repo_url}")
        print("\n📖 Usage example:")
        print("```python")
        ...
        print(f'model_path = hf_hub_download("omgbobbyg/satellite-equipment-detection-yolov8n-vhr10", "best.pt")')
        print("model = YOLO(model_path)")
        print("results = model('satellite_image.jpg')")
        print("```")
    else:
